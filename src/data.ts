...
export const TAG_ICONS: Record<string, { icon: string; label: string; color: string; bg: string; hex: string; border?: boolean }> = {
    ...
    advice: { icon: 'help-circle', label: 'Advice', color: 'text-violet-600', bg: 'bg-violet-50', hex: '#7c3aed' },
...
export const ALL_DATA: Resource[] = [
    // --- 🟢 FOOD (EAT) ---
    {
        ...
        // Checked: Usually Tuesday evenings
        schedule: { 0: "Closed", 1: "Closed", 2: "18:00-19:30", 3: "Closed", 4: "Closed", 5: "Closed", 6: "Closed" },
        lat: 50.7993,
        lng: -1.1002,
    ...
    },
    {
        ...
        // Checked: Open mornings and some evenings
        schedule: { 0: "Closed", 1: "Closed", 2: "09:00-11:30", 3: "09:00-11:30", 4: "18:00-20:00", 5: "Closed", 6: "Closed" },
        lat: 50.7853,
        lng: -1.0772,
        phone: "07800 933 983",
        trustScore: 100,
    ...
    },
    {
        ...
        tags: ["free", "warmth", "hot_meal", "no_referral"],
    ...
    },
    {
        ...
        tags: ["community", "coffee", "free", "support", "no_referral"],
    ...
    // --- 🛌 SHELTER (STAY) ---
    {
        ...
        requirements: "Local connection usually required. Drop-in available.",
        tags: ["emergency", "support", "advice", "no_referral"],
    ...
    },
    {
        ...
        description: "Breakfast (8-12), showers, laundry, and housing advice. Closed 12-1pm daily.",
        requirements: "For verified rough sleepers.",
        tags: ["shower", "laundry", "hot_meal", "support", "no_referral"],
    ...
    // --- 🔥 WARMTH & LIBRARIES ---
    {
        ...
        tags: ["free", "wifi", "charging", "toilet", "learning", "digital_support", "no_referral"],
    ...
    },
    {
        ...
        requirements: "Open to all.",
        tags: ["free", "wifi", "family", "learning", "no_referral"],
    ...
    },
    {
        ...
        requirements: "Open to all.",
        tags: ["free", "wifi", "learning", "digital_support", "no_referral"],
        schedule: { 0: "Closed", 1: "09:30-17:00", 2: "09:30-17:00", 3: "09:30-17:00", 4: "09:30-17:00", 5: "09:30-17:00", 6: "10:00-15:30" },
        lat: 50.8125,
        lng: -1.0770,
        trustScore: 98
    },
    {
        ...
        requirements: "Open to all.",
        tags: ["free", "wifi", "learning", "community", "no_referral"],
    ...
    },
    {
        ...
        requirements: "Open to all.",
        tags: ["free", "wifi", "learning", "no_referral"],
    ...
    // --- 🏥 COMMUNITY & SUPPORT CENTERS (EXPANDED) ---
    {
        ...
        requirements: "Open to all.",
        tags: ["community", "activities", "learning", "no_referral"],
    ...
    },
    {
        ...
        requirements: "Open to all.",
        tags: ["community", "activities", "senior", "no_referral"],
    ...
    },
    {
        ...
        requirements: "Open to all.",
        tags: ["community", "family", "activities", "no_referral"],
    ...
    },
    {
        ...
        requirements: "Open to all.",
        tags: ["community", "pets", "activities", "no_referral"],
    ...
    },
    {
        ...
        requirements: "Drop-in.",
        tags: ["free", "advice", "no_referral", "support"],
    ...
    },
    {
        ...
        tags: ["addiction", "health", "free", "no_referral"],
    ...
    },
    {
        ...
        requirements: "Drop-in or Appointment.",
        tags: ["mental_health", "free", "support", "no_referral"],
    ...
    },
    {
        ...
        tags: ["mental_health", "medical", "free", "no_referral"],
    ...
    // --- 👪 FAMILY HUBS (COMPLETE) ---
    {
        ...
        tags: ["free", "community", "children", "medical", "no_referral"],
    ...
    },
    {
        ...
        tags: ["free", "community", "children", "no_referral"],
        schedule: { 0: "Closed", 1: "08:30-17:00", 2: "08:30-17:00", 3: "08:30-17:00", 4: "08:30-17:00", 5: "08:30-16:30", 6: "Closed" },
        lat: 50.7954,
        lng: -1.0905,
        trustScore: 100
    ...
    },
    {
        ...
        requirements: "Drop-in.",
        tags: ["free", "children", "community", "medical", "no_referral"],
        schedule: { 0: "Closed", 1: "08:30-17:00", 2: "08:30-17:00", 3: "08:30-17:00", 4: "08:30-17:00", 5: "08:30-16:30", 6: "Closed" },
        lat: 50.8245,
        lng: -1.0770,
        trustScore: 99
    },
    {
        ...
        requirements: "Drop-in.",
        tags: ["free", "children", "community", "no_referral"],
        schedule: { 0: "Closed", 1: "08:30-17:00", 2: "08:30-17:00", 3: "08:30-17:00", 4: "08:30-17:00", 5: "08:30-16:30", 6: "Closed" },
        lat: 50.8495,
        lng: -1.0940,
        trustScore: 99
    ...
    // --- 🛍️ CHARITY SHOPS (COMPLETE MERGE) ---
    {
        ...
        requirements: "Open to all.",
        tags: ["charity", "shopping", "no_referral"],
    ...
    },
    {
        ...
        requirements: "Open to all.",
        tags: ["charity", "shopping", "learning", "no_referral"],
    ...
    },
    {
        ...
        requirements: "Open to all.",
        tags: ["charity", "shopping", "family", "no_referral"],
        schedule: { 0: "10:00-16:00", 1: "09:00-17:00", 2: "09:00-17:00", 3: "09:00-17:00", 4: "09:00-17:00", 5: "09:00-17:00", 6: "09:00-17:00" },
        lat: 50.7865,
        lng: -1.0830,
        trustScore: 94
    ...
    },
    {
        ...
        requirements: "Open to all.",
        tags: ["charity", "shopping", "pets", "no_referral"],
        schedule: { 0: "10:00-16:00", 1: "09:00-17:00", 2: "09:00-17:00", 3: "09:00-17:00", 4: "09:00-17:00", 5: "09:00-17:00", 6: "09:00-17:00" },
        lat: 50.8105,
        lng: -1.0838,
        trustScore: 95
