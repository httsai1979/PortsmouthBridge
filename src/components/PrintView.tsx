...
const PrintView = ({ data, onClose }: { data: Resource[], onClose: () => void }) => {
    ...
    return (
        <div className="fixed inset-0 z-[9999] bg-white overflow-y-auto print-container">
            {/* Control Bar (Hidden when printing) */}
            <div className="sticky top-0 bg-indigo-600 text-white p-4 flex justify-between items-center print:hidden shadow-lg">
                <div>
                ...
                <div className="flex gap-3">
                    <button onClick={() => window.print()} className="px-6 py-2 bg-white text-indigo-600 rounded-full font-bold text-sm shadow-sm hover:bg-indigo-50">
                        Print
                    </button>
